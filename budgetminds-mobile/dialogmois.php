...
<div data-role="dialog" data-url="depenses.php">
		...
		<div data-role="header" data-theme="a" role="banner">
			<h1 class="ui-title" role="heading" aria-level="1">Mois <?php echo date('m', strtotime($_GET['date'])); ?></h1>
		</div>
		...
		<div data-role="content" data-theme="c" role="main">
				...
				<?php 
					...
					$req = $bdd->prepare('SELECT * FROM depenses WHERE id_users=:id_users AND MONTH(coldate) = MONTH(\''.$getdate.'\') ORDER BY coldate DESC');
